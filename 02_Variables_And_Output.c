...
int main() {
    ...
    char myString[] = "Hello";  // String (array of characters)           (6 bytes,
                                // including the null terminator) can also take
                                // more than 6 bytes if the string is longer
    ...
    //                   followed by a chracter that indicates the type of data to
    //                   be printed and optional modifiers that specify the width,
    //                   precision, or other formatting options for the output
    //                   they control how the output is formatted and displayed on
    //                   the screen
    ...
    printf("Boolean: %d\n", isTrue);       // the %d is used to print a boolean value (1
